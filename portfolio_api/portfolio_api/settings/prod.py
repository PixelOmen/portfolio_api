...
DATABASES = {
    "default": {
        ...
        "HOST": env("POSTGRES_DB_HOST_PROD"),
...
AWS_S3_REGION_NAME = env("AWS_S3_REGION_NAME_PROD")
...
CACHES = {
    "default": {
        ...
        "LOCATION": env("DJANGO_CACHE_PROD"),
        "OPTIONS": {
...
# Channels
CL_HOST, CL_PORT, CL_DB = env("CHANNEL_LAYERS_REDIS_PROD").split(":")
CHANNEL_LAYERS = {
    "default": {
...
# Celery
CELERY_BROKER_URL = env("CELERY_BROKER_URL_PROD")
CELERY_RESULT_BACKEND = env("CELERY_RESULT_BACKEND_PROD")

# Email
EMAIL_PORTFOLIO_LINK = env("EMAIL_PORTFOLIO_LINK_PROD")
EMAIL_LOGO_URL = env("EMAIL_LOGO_URL_PROD")
...
CSRF_TRUSTED_ORIGINS = ["https://eacosta.dev"]
